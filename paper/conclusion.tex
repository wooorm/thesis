...
In this section, the research question defined is evaluated
...
These answers, answers the complete research question, within the scope
  (§ \ref{scope}, p. \pageref{scope}).

\subsection{Research Objective}\label{q-research-objective}

How to create a specification and program was answered by the research
  question, but the working proposal reaches the research objective.
This was validated by the more than fifteen plugins solving the target
