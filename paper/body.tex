...
Many implementations exist for this task\footnote{For example,
  \autocite{thinkroth/sentimental-source-code},
  \autocite{mileszim/sediment-source-code},
  \autocite{thisandagain/sentiment-source-code}.} on the web platform,
...
available\footnote{For example,
  \autocite{jbrooksuk/node-summary-source-code} on the web,
  \autocite{MojoJolo/textteaser-source-code} in Scala.}.
