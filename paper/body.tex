...
\noindent This objective leads to a research question:
...
\item
  ...
  \begin{enumerate}
    \item What would the target audience use an implementation for?
    \item What would the target audience \emph{not} use the implementation
      for?
  \end{enumerate}
\item
