...
\noindent \gls{nlp} covers many different tasks, but the process of
  accomplishing these goals touches, as seen above, on well defined stages.
...
\item\emph{Embedded content} --- Punctuation marks are sometimes used in
  nonstandard ways, such as when a section or chapter delimiter is
...
\item Transforming emoji shortcodes (:cat:) into real emoji
...
\noindent These plugins listed and the other plugins solve several use cases
