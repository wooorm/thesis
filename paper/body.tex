...
\subsection{Using Corpora for \gls{nlp}}\label{using-corpora-for}
...
\subsection{Using a web \acrshort{api}}\label{using-a-web}
...
\subsection{Syntax: \acrshort{nlcst}}\label{syntax}
...
\subsection{Object Model: \acrshort{textom}}\label{object-model}
...
\subsection{\acrshort{api} Design}\label{design-1}
