...
The in this paper proposed implementations were produced with high regards for performance. Performance includes the software having a small file size in order to reach the client over the network with high speed, but most importantly the executing of code should operate efficiently and at at high speeds.

#### Testing

With the development of the in this paper introduced software, testing was given high priority. Testing, in software development, refers to multiple subgroups of validating if software does what it is supposed to do.
...
Great care was given to develop a full test suite with 100% coverage for every program. Coverage, in software development, is a term used to describe the tested amount of code that. 100% coverage stands for full coverage (every part of the code is covered).
...
Great attention was given to code quality, how readable for humans the software was. Special focus was given to consistency and clearness.
...
https://speakerdeck.com/ariya/javascript-api-design-principles
https://www.joyent.com/developers/node/design#codingstyle
